...
private package Libadalang.Debug is
   ...
   --  "Print Tree". Shortcut for Node.Print. This is useful because Print is
   --  a dispatching primitive whereas these are difficult to call from GDB.
   ...
   procedure PRel (Rel : Relation; Context_Node : Bare_Ada_Node);
