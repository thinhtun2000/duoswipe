...
private package Libadalang.Parsers is
   ...
   type Parsed_Node is access all Implementation.Root_Node_Record;
   ...
   --  Init a parsto parse the given source. The resulting tokens (and trivia
   --  if With_Trivia) are stored into TDH.
   --
   --  This can raise:
   --
